...
* **__load_completion:** check that a completion was actually set ([f16dd80](https://github.com/scop/bash-completion/commit/f16dd8049850a30cb298c2c450bf02f1e4451d72))
* **__load_completion:** localize default `$IFS` ([d1a2999](https://github.com/scop/bash-completion/commit/d1a299949005498332bed7f3ac97b14f710ef9b9))
* **__load_completion:** pass absolute path when sourcing and available ([6b8d4a5](https://github.com/scop/bash-completion/commit/6b8d4a5b5963c1af9710099b146a201f55fa6b87))
* **__load_completion:** pass backslashless command to fallback loads ([5618654](https://github.com/scop/bash-completion/commit/56186541f5a382056cfc25e1d08f5da8018076b8))
* **__load_completion:** source all completions with same args ([9e07654](https://github.com/scop/bash-completion/commit/9e076543de380e08467e9aa45951c172826f8022))
* **_comp_abspath:** new utility function, use in `_comp_realcommand` ([28b587a](https://github.com/scop/bash-completion/commit/28b587a47058395fdacb7eafe866685af1e74e3c))
...
* **_comp_compgen_set:** add a function to just store values ([f9c0471](https://github.com/scop/bash-completion/commit/f9c04719df98ee32e46f6939dc9bf885a9151c5f))
* **_comp_compgen:** add helper function to call compgen ([652f9e4](https://github.com/scop/bash-completion/commit/652f9e41bc406102b76a80d96d904616712ede7c))
* **_comp_compgen:** inherit options inside _comp_compgen NAME ([e34e38f](https://github.com/scop/bash-completion/commit/e34e38fe3b3d5babf30c6ed77ab6b0ea56de104f))
...
* **_comp_split:** return if any elems are generated via exit status ([7e2692a](https://github.com/scop/bash-completion/commit/7e2692ae0c580a141b018d3af1b7fd2bfbc84869))
...
* Add support for ping4 ([697c276](https://github.com/scop/bash-completion/commit/697c2767c3200c274dc520861f6fe2e9760ba615))
...
* **allero:** add fallback 3rd party completion loader ([d712647](https://github.com/scop/bash-completion/commit/d712647a9a3e0d89417e4488c359fd599bb1246e))
...
* **arduino-cli:** add fallback 3rd party completion loader ([723b026](https://github.com/scop/bash-completion/commit/723b026d36cc616190065b4b2d7b957edafad461))
* **b2sum:** new completion ([cd985df](https://github.com/scop/bash-completion/commit/cd985df6d8e613fd5421066248db1c50dc1686bd))
* **bash_completion.d:** load from one relative to the main script ([cdd8a15](https://github.com/scop/bash-completion/commit/cdd8a157abdbb4ce2e74df3fd8131a2b199152e6))
...
* **buf:** add fallback 3rd party completion loader ([18c8945](https://github.com/scop/bash-completion/commit/18c8945892a94e6977f8cbf349508a216ce1a984))
* **c3s:** add fallback 3rd party completion loader ([aaf792d](https://github.com/scop/bash-completion/commit/aaf792d00f31dc427ad798e48891ac5f0c8255dd))
* **cargo:** add fallback 3rd party completion loader ([7cd9cb9](https://github.com/scop/bash-completion/commit/7cd9cb91408cebbd112bf3643184647006fe2490))
* **cilium:** add fallback 3rd party completion loader ([df39865](https://github.com/scop/bash-completion/commit/df398656a32e37ef2fb853f0dfd7b328f1bce873))
* **cloudquery:** add fallback 3rd party completion loader ([3deb530](https://github.com/scop/bash-completion/commit/3deb530e2b3c2d398f482fa45416517885403029))
* **constellation:** add fallback 3rd party completion loader ([760abd7](https://github.com/scop/bash-completion/commit/760abd7a7156d9b6c0505baee1a104d7cf5b7263))
* **consul:** add fallback 3rd party completion loader ([7bf6c51](https://github.com/scop/bash-completion/commit/7bf6c517a369aa8076520458944b2d963bd9a627))
...
* **datree:** add fallback 3rd party completion loader ([3ae21a7](https://github.com/scop/bash-completion/commit/3ae21a70a11504d0c71190d52b79d20d3f3f35f4))
* **deno:** add fallback 3rd party completion loader ([7b8344d](https://github.com/scop/bash-completion/commit/7b8344d34dc797bd8b3dba23fcc163f7626a2064))
* **diesel:** add fallback 3rd party completion loader ([2ae33fa](https://github.com/scop/bash-completion/commit/2ae33fa66e7eef5ccd7f0c9d03ddd2c8fdfea94a))
* **docker:** add fallback 3rd party completion loader ([d1c7916](https://github.com/scop/bash-completion/commit/d1c791624e0a15ccc1b27253178625f9b6700d1a))
...
* **flamegraph:** add fallback 3rd party completion loader ([b161be8](https://github.com/scop/bash-completion/commit/b161be8ff17c1f00ee0c010c7fd42a78ae34b580))
* **gaiacli:** add fallback 3rd party completion loader ([639415d](https://github.com/scop/bash-completion/commit/639415de2a38e91d46cefcf6154576bedbd7aeaf))
* **gaiad:** add fallback 3rd party completion loader ([3bcd7fc](https://github.com/scop/bash-completion/commit/3bcd7fc07d2b9b8d83d207e6b0f1b6d22d1c5413))
* **gardenctl:** add fallback 3rd party completion loader ([b4c9563](https://github.com/scop/bash-completion/commit/b4c95631fa01c2f62f48fada3d3cddb7bd8f4aa9))
* **gh-label:** add fallback 3rd party completion loader ([01834c1](https://github.com/scop/bash-completion/commit/01834c1670aad0e661c6fd7f6982cdf69d5b3e6f))
* **gh:** add fallback 3rd party completion loader ([f402bf0](https://github.com/scop/bash-completion/commit/f402bf005abdd9f7ff2a63f5ef9130d750246753))
* **git-bump:** add fallback 3rd party completion loader ([3371af6](https://github.com/scop/bash-completion/commit/3371af6442b40a99fd8327ebc1ebd389088ad2bb))
* **go-licenses:** add fallback 3rd party completion loader ([f8793b4](https://github.com/scop/bash-completion/commit/f8793b492d71e68be5820fd422fee5c2605cb9b1))
* **golangci-lint:** add fallback 3rd party completion loader ([363b9fc](https://github.com/scop/bash-completion/commit/363b9fce79b73b639b5bfce8fe241b04868d8176))
* **gopherjs:** add fallback 3rd party completion loader ([5fd249d](https://github.com/scop/bash-completion/commit/5fd249db7b26597c61e391509bed85bd19b2987c))
* **goreleaser:** add fallback 3rd party completion loader ([4c5c5c4](https://github.com/scop/bash-completion/commit/4c5c5c49184e2ad977cc3751799fcd59a8108f27))
* **gsctl:** add fallback 3rd party completion loader ([5e08c0f](https://github.com/scop/bash-completion/commit/5e08c0f584284dcf48abe16e5caafae57e678792))
...
* **helm:** add fallback 3rd party completion loader ([0b26b9c](https://github.com/scop/bash-completion/commit/0b26b9c346ffc985d38b97070c5ba4ea9a3ba561))
* **hugo:** add fallback 3rd party completion loader ([031e317](https://github.com/scop/bash-completion/commit/031e317c6688f2129995bc44851bb7a9d689a33c))
* **ignite:** add fallback 3rd party completion loader ([db74c54](https://github.com/scop/bash-completion/commit/db74c54532cd7d59b0fb714bbdd52e944b102941))
* **infracost:** add fallback 3rd party completion loader ([229643e](https://github.com/scop/bash-completion/commit/229643e5ddc55a63b2194cd371aa0e7db45a5949))
* **inotifywait:** add `--include`/`--includei` arg non-completion ([299551a](https://github.com/scop/bash-completion/commit/299551a3daa1466aac6dc3b07c654a8ff302e97b))
* **istioctl:** add fallback 3rd party completion loader ([8767497](https://github.com/scop/bash-completion/commit/8767497e0b934e9c8deea28ea7702074fa51ffbc))
* **kn:** add fallback 3rd party completion loader ([328ecf7](https://github.com/scop/bash-completion/commit/328ecf74bc5cb14c91329d8fb1922b9d033ade1c))
* **kool:** add fallback 3rd party completion loader ([d7b2695](https://github.com/scop/bash-completion/commit/d7b26951c7a9cd6c77e9a2e1161db023c6342db9))
* **kratos:** add fallback 3rd party completion loader ([f674bac](https://github.com/scop/bash-completion/commit/f674bac7debc430197d1a59d52421278ff9561f3))
* **kubeadm:** add fallback 3rd party completion loader ([963b4c4](https://github.com/scop/bash-completion/commit/963b4c41bae4deaf2e1675cedd7fd6bd6ad3936d))
* **kubectl:** add fallback 3rd party completion loader ([d0dd3aa](https://github.com/scop/bash-completion/commit/d0dd3aae50feeca3535294bb4574af81102fc8ed))
* **kubescape:** add fallback 3rd party completion loader ([7068e7a](https://github.com/scop/bash-completion/commit/7068e7a454054347744815e507cc08d78dc19201))
* **linkerd:** add fallback 3rd party completion loader ([bdd106c](https://github.com/scop/bash-completion/commit/bdd106ca784d29712e0c1c792f6fbc6329a5b514))
...
* **mattermost:** add fallback 3rd party completion loader ([fc83503](https://github.com/scop/bash-completion/commit/fc83503258b533695b360c77ec7c25bd9b03ca10))
* **mdbook:** add fallback 3rd party completion loader ([f695c54](https://github.com/scop/bash-completion/commit/f695c54d5521b9d8a238e5afccec86fc6f3f0f55))
* **metalctl:** add fallback 3rd party completion loader ([f5499c4](https://github.com/scop/bash-completion/commit/f5499c4e539f1463361070ec7782e83a900155f7))
* **minikube:** add fallback 3rd party completion loader ([4936bed](https://github.com/scop/bash-completion/commit/4936bed7399d37116120d94b943cad0c45fd09d3))
* **mmctl:** add fallback 3rd party completion loader ([5c6f972](https://github.com/scop/bash-completion/commit/5c6f9720f4f482e23f2b8164247ce9d834f5a476))
* **moldy:** add fallback 3rd party completion loader ([31f2f92](https://github.com/scop/bash-completion/commit/31f2f924aef3696c3986c9056b7c4934f173bb96))
* **multi-gitter:** add fallback 3rd party completion loader ([1280f0a](https://github.com/scop/bash-completion/commit/1280f0ac0cc95f7b30068cf6fa3ed43cf346c880))
...
* **nfpm:** add fallback 3rd party completion loader ([a43a718](https://github.com/scop/bash-completion/commit/a43a71835666d6980446bc07d8c360fb5aa09ae8))
...
* **nomad:** add fallback 3rd party completion loader ([63a3bdf](https://github.com/scop/bash-completion/commit/63a3bdfc3d98c8edea5462b2dcdd5839c93a8025))
* **nox:** `register-python-argcomplete` lookup improvements ([9620bc9](https://github.com/scop/bash-completion/commit/9620bc92a71c8fe050a122fbf59410dabb68165d))
* **nox:** add fallback 3rd party completion loader ([272ab45](https://github.com/scop/bash-completion/commit/272ab45c56623ea6ed65e44b9cef7bfc7bead2d6))
* **okteto:** add fallback 3rd party completion loader ([b428048](https://github.com/scop/bash-completion/commit/b4280485702117f240804a36ef27eb65c6b8454a))
* **ory:** add fallback 3rd party completion loader ([588d813](https://github.com/scop/bash-completion/commit/588d8135c963b782807da57d6dc7302a108791e4))
* **packer:** add fallback 3rd party completion loader ([961a629](https://github.com/scop/bash-completion/commit/961a629f3be9fb440a8494d519814bdbe6160b26))
* **polygon-edge:** add fallback 3rd party completion loader ([850ffa1](https://github.com/scop/bash-completion/commit/850ffa1ff1c6cbecd45e4e736c6694d2fa47c254))
* **pulumi:** add fallback 3rd party completion loader ([7fcd4ae](https://github.com/scop/bash-completion/commit/7fcd4aea45ca7d9a098b2d94de371ef1d5b8c216))
* **px:** add fallback 3rd party completion loader ([b317aa9](https://github.com/scop/bash-completion/commit/b317aa97627ba7de974e720f049ba13a6ce706cc))
* **python,pyvenv:** 3.12 support ([bed99a4](https://github.com/scop/bash-completion/commit/bed99a4e4979343b6d8e82288f3433d61ebf0d4a))
* **qrpc:** add fallback 3rd party completion loader ([bd5759e](https://github.com/scop/bash-completion/commit/bd5759e9c52be47009c865cc13008c1db0c35a6e))
* **random:** add fallback 3rd party completion loader ([93d5fe9](https://github.com/scop/bash-completion/commit/93d5fe93cd92808862fa5ea2737c5167fbd67e92))
* **rclone:** add fallback 3rd party completion loader ([c0d3f6b](https://github.com/scop/bash-completion/commit/c0d3f6b0bcb874b99bf100f6e280b4b5d5f23298))
* **rsync:** add completion for --info values ([b1d163e](https://github.com/scop/bash-completion/commit/b1d163e99e17bcfbc79ee1b6151d8295307d8bc6))
* **ruff:** add fallback 3rd party completion loader ([d27b144](https://github.com/scop/bash-completion/commit/d27b144016439f6b5e9fcebca6779ca61a23b9ce))
* **rustup:** add fallback 3rd party completion loader ([8610d7d](https://github.com/scop/bash-completion/commit/8610d7dc8b9b3630b469a3982a162e218bf967ad))
...
* **skaffold:** add fallback 3rd party completion loader ([4b35250](https://github.com/scop/bash-completion/commit/4b352505f662b96e503d3e08c4f76c3a8feb5a54))
...
* **sshi:** add fallback 3rd party completion loader ([ef651f8](https://github.com/scop/bash-completion/commit/ef651f82051951e1a5782d48ef453d0957fa9410))
* **starship:** add fallback 3rd party completion loader ([f091a53](https://github.com/scop/bash-completion/commit/f091a533bda5897c7560796653805b335b79d869))
* **tanzu-core:** add fallback 3rd party completion loader ([7468d4c](https://github.com/scop/bash-completion/commit/7468d4c9ba086ea002fa3ec0ed38a9b263967447))
* **tanzu:** add fallback 3rd party completion loader ([ec5a562](https://github.com/scop/bash-completion/commit/ec5a56205f4ce339769e78ecaadb6bffac01d89c))
* **tendermint:** add fallback 3rd party completion loader ([145f990](https://github.com/scop/bash-completion/commit/145f9902b6068f46389796e167e04bc8b173d2e9))
* **terraform:** add fallback 3rd party completion loader ([58d3f5f](https://github.com/scop/bash-completion/commit/58d3f5f315aa99dd91ab6d416c63e7d42b64a3bc))
* **tokio-console:** add fallback 3rd party completion loader ([1bedb38](https://github.com/scop/bash-completion/commit/1bedb38841368d57ce2f967e3311e603b93557f0))
* **trivy:** add fallback 3rd party completion loader ([23885d8](https://github.com/scop/bash-completion/commit/23885d89843f900b0cc9f4e91729af84bd79f208))
* **upctl:** add fallback 3rd party completion loader ([f4e3109](https://github.com/scop/bash-completion/commit/f4e310952c3c5c4e2d140e8019713c614b1b6ca6))
* **vacuum:** add fallback 3rd party completion loader ([3a1103e](https://github.com/scop/bash-completion/commit/3a1103e26ccffb96befd272b7d39c01923c42f94))
* **vault:** add fallback 3rd party completion loader ([3303515](https://github.com/scop/bash-completion/commit/33035150bd5b601d08120aba3953c1df001b00b5))
* **virtctl:** add fallback 3rd party completion loader ([ad16c1c](https://github.com/scop/bash-completion/commit/ad16c1c2726ba5b73cdf45c00b76e17addd02e49))
* **watchexec:** add fallback 3rd party completion loader ([908e588](https://github.com/scop/bash-completion/commit/908e58892d1536b7441b0b9abba449b00f2c27f5))
* **yq:** add fallback 3rd party completion loader ([3c1947b](https://github.com/scop/bash-completion/commit/3c1947bc3bcb0cead57c522028ecb161e6ce43d2))
* **zitadel:** add fallback 3rd party completion loader ([f968a7d](https://github.com/scop/bash-completion/commit/f968a7dab81eaf2dc2e0522d92757cd4e6c9a884))


### Bug Fixes

* **__load_completion:** check `_comp_realcommand` return code ([42d8269](https://github.com/scop/bash-completion/commit/42d8269b59d0f3affd3bae754f79e55e3a977486))
* **__load_completion:** check if `cmd` is absolute for bin dir ([6b75d64](https://github.com/scop/bash-completion/commit/6b75d64667446d11c89cd36836d29b5d40c76d82))
* **__load_completion:** don't resolve symlinks to invoked command ([e4ede51](https://github.com/scop/bash-completion/commit/e4ede514249c4250dd43139f54fa3c46554a1dbc))
* **__load_completion:** pass full path to fallback completion loaders ([e01c4a1](https://github.com/scop/bash-completion/commit/e01c4a1e2716fdc2fc7ac471948f24fa9c69e8ca))
...
* **__load_completion:** search completions in share/ from real path ([61982cb](https://github.com/scop/bash-completion/commit/61982cbcf5cb283dfcf6b7863127fd1dda2e5985))
* **__parse_options:** remove unneeded IFS adjustment ([183e265](https://github.com/scop/bash-completion/commit/183e2652a404d1ae7d6cc89a2f100bcf0d9d8a50))
* **_adb:** avoid non-POSIX \? in BRE ([86f9134](https://github.com/scop/bash-completion/commit/86f913455936b064b9aea9f5876a6a41d3667925))
* **_command_offset:** fix offset mismatching for words vs COMP_WORDS ([f190181](https://github.com/scop/bash-completion/commit/f19018136c8084f8c9e29b20af7d809f6c509be8))
* **_command_offset:** receive index in COMP_WORDS through compat name ([06bfe23](https://github.com/scop/bash-completion/commit/06bfe23e7bcfd98cffaa53dd0af5304a273fc7b6))
* **_comp_cmd_smartctl__device:** replace COMPREPLY ([2c9a1a9](https://github.com/scop/bash-completion/commit/2c9a1a979565fecc3d352c23669e5f084e2f1f0f))
...
* **_comp_compgen:** adjust IFS for a quoting fix in bash 5.0 ([f45cd30](https://github.com/scop/bash-completion/commit/f45cd30726b625f9f14b3dda0a9d7c65c42491fa))
* **_comp_compgen:** change interface ([7da1af1](https://github.com/scop/bash-completion/commit/7da1af11983ad15b62852d789b0a43977e8b85da))
* **_comp_compgen:** improve argument check ([c898bdb](https://github.com/scop/bash-completion/commit/c898bdb7cd2c55e0a53b5641d710664e58bb3f41))
* **_comp_compgen:** prevent IFS from affecting `-- "$cur"` ([3cf004c](https://github.com/scop/bash-completion/commit/3cf004c7cbc0cdbc304ea3e0600a146c7f2cbfaa))
* **_comp_compgen:** update code comments ([ace5d5b](https://github.com/scop/bash-completion/commit/ace5d5b4a11f3ebe836571a1f795086e0c86d620))
* **_comp_delimited,cvs:** add guards against `set -o nounset` ([284df27](https://github.com/scop/bash-completion/commit/284df270481510da3e0c4539960471ae64be4917))
* **_comp_delimited:** prepend prefix to all compreply args ([0eea357](https://github.com/scop/bash-completion/commit/0eea3576b0ec45091d30a8040ef0c2785366b473))
* **_comp_delimited:** work around bash-4.2 quoting ([e923e7f](https://github.com/scop/bash-completion/commit/e923e7f2db758ae667e1667cacc860f717811c3b))
* **_comp_realcommand:** absolutize more in fallback case ([ed01af3](https://github.com/scop/bash-completion/commit/ed01af368fee8b3922661eafc6afdbf6d4d8463f))
...
* **_get_comp_words_by_ref:** protect against custom IFS ([7ba4b4a](https://github.com/scop/bash-completion/commit/7ba4b4a27cdc007c133c3b83781ad7148c347ea0))
* **_known_hosts_real:** fix "nounset" error with empty known_hosts ([dbae115](https://github.com/scop/bash-completion/commit/dbae11557484f96564c65dd345c45b3cc7b03ed8))
* **_known_hosts:** work around localvar_inherit ([b2c6d9a](https://github.com/scop/bash-completion/commit/b2c6d9a3932eb53cb8fb1671b37232bb87adaae0))
* **_minimal:** fall back to defaults instead of `_filedir` ([b9c56eb](https://github.com/scop/bash-completion/commit/b9c56ebf00d1e4c4f85d87b40026497dbb97d6f6))
* **_service:** quote word ([c2d7fb7](https://github.com/scop/bash-completion/commit/c2d7fb73844531ccb10576ddd905fb058e00c88e))
* **_tilde:** fix false negative with 256 generated users ([177cba1](https://github.com/scop/bash-completion/commit/177cba155a39229da986de41b2ac5bca20bf3045))
* **_udevcmd:** protect against `localvar_inherit` ([c7877e9](https://github.com/scop/bash-completion/commit/c7877e96a8b8d213edadbf69050e639cf037fe9d))
* **_udevcmd:** use param $2 of `_parse_help` ([683a476](https://github.com/scop/bash-completion/commit/683a47628a8b4479a6451125cb850a1dda0be649))
* **_umount.linux:** fallout from naming changes ([5a300b2](https://github.com/scop/bash-completion/commit/5a300b2c3984a2a4372aca8b9f2092217dacb89d))
* `$split && return` =&gt; `[[ $was_split ]] && return` for custom IFS ([44c4327](https://github.com/scop/bash-completion/commit/44c4327b654c4bb184ffbd3c27d041bfe011f1ac))
...
* **abook,curl,pack200,patch,perl:** specify -a to filedir ([2d12cbe](https://github.com/scop/bash-completion/commit/2d12cbeb72baaa56961b054067300a057716dea3))
* **autotools:** quote words ([a2353b1](https://github.com/scop/bash-completion/commit/a2353b1fec5209cfc3e3604be598a37a805b308e))
* **badblocks:** protect against `failglob` ([7fcf0c6](https://github.com/scop/bash-completion/commit/7fcf0c6b33e3f2bf0b51f50430aa9a4b076bdadf))
* **carton,gssdp-discover,influx:** use normal IFS ([e41e3b5](https://github.com/scop/bash-completion/commit/e41e3b5dbafb2b4fad6559fd4fb819151b4198b4))
* **cd,mplayer:** use _comp_{split,compgen} ([696c4a5](https://github.com/scop/bash-completion/commit/696c4a5bee3692e70cc5a0f4126b840405b695ec))
* **compat:** checking non-empty `$BASH_COMPLETION_COMPAT_DIR` ([b9db024](https://github.com/scop/bash-completion/commit/b9db024fe6a93a831e8e1785d9057ea2223d2676))
* **complete:** remove empty elements ([a3071f3](https://github.com/scop/bash-completion/commit/a3071f3ec307db96a7d63e258094c2a4743e8624))
* **cpan2dist:** fix leaked variable `dir` ([1bdc18e](https://github.com/scop/bash-completion/commit/1bdc18e4a70c2e00416ea90f3a02b968acd916a7))
* **cppcheck:** include 1 as completions ([5a5c62d](https://github.com/scop/bash-completion/commit/5a5c62d91f05ed185270eb8bc4a9d98f3e139cef))
...
* **curl:** fix option listing in newer versions ([e88a216](https://github.com/scop/bash-completion/commit/e88a2168436db08f8b3f4106f17036490410c99f))
* **cvs:** fix argument parsing (regression by d0a0eb597) ([dc926e3](https://github.com/scop/bash-completion/commit/dc926e306ce6f0c87e907e9ea7f29931d7122725))
* **cvs:** fix localvar_inherit ([9d0e600](https://github.com/scop/bash-completion/commit/9d0e600e2dd24bd17c4407b98c63162d98230cab))
* **dict,invoke-rc.d,koji,pkg-config,qdbus:** quote arguments ([6db40e6](https://github.com/scop/bash-completion/commit/6db40e63d0e76e230f38f9e06e1efbe818eeef15))
* **dpkg-source,pkgadd:** remove redundant "_filedir -d" ([4645ecd](https://github.com/scop/bash-completion/commit/4645ecdf41b3ba5730c2f2f22dbeb398c47aecab))
* **ebtables,iptables:** quote table name ([2f564a7](https://github.com/scop/bash-completion/commit/2f564a70f0046abf34dabc7a41897126d6b6b687))
* **ebtables,iptables:** work around localvar_inherit ([5edb278](https://github.com/scop/bash-completion/commit/5edb27839fcffd50e54889ef65b7b48b4d7737d8))
* **filedir:** avoid variable name conflicts ([926b48d](https://github.com/scop/bash-completion/commit/926b48db479013c49576b23d15016bca6bb30cb9))
...
* **gcc:** quote the command name $1 for custom IFS ([26d8b34](https://github.com/scop/bash-completion/commit/26d8b345eee07e15937219ca3908bfa15ac9caf9))
* **gnokii:** avoid non-POSIX BRE \| ([3a8a2ed](https://github.com/scop/bash-completion/commit/3a8a2ede974d520208cc5ab006781e287f4fe09f))
* **gnokii:** avoid non-POSIX ERE \b ([fb130ad](https://github.com/scop/bash-completion/commit/fb130ad1616453e69207cdeb618750b5f34e63e8))
* **gnokii:** escape ERE special characters in constructed regex ([39a01d3](https://github.com/scop/bash-completion/commit/39a01d3ca03e11018032ba1d52053150543a2dc0))
* **gnokii:** remove redundant LANG=C ([7bf4ec2](https://github.com/scop/bash-completion/commit/7bf4ec271be5b29e5e511d460aa87811b70742f6))
* **gnome-mplayer:** fix wrong option -w for `compgen` ([48d9cc5](https://github.com/scop/bash-completion/commit/48d9cc5ae29237ab4aabc596283d850c219be1bd))
* **hping2:** fix unfiltered option listing for `--tos` ([7e49307](https://github.com/scop/bash-completion/commit/7e493070b92649b4e3922a6d05c3955de4c5dc04))
...
* **java:** fix `_comp_cmd_java__packages` for IFS/failglob/splitting ([e1b22b8](https://github.com/scop/bash-completion/commit/e1b22b8a25f60697ac638bdebf22081afeb7a6af))
* **java:** fix `_java_find_sourcepath` to store results in array ([502fd11](https://github.com/scop/bash-completion/commit/502fd110b1f9b39d35af20ab6ac8262937836ea1))
* **java:** fix a bug of assigning results in `cur` but not `COMPREPLY` ([55d0e07](https://github.com/scop/bash-completion/commit/55d0e07b0f58b3cbe1b80b836ce62d7f7a8cf720))
* **java:** localize `cur` not to affect outside the function ([3818ee6](https://github.com/scop/bash-completion/commit/3818ee6693013cd6350967d81547e169aeea2444))
...
* **lintian,python,smartctl:** return when completions are generated ([5598b5c](https://github.com/scop/bash-completion/commit/5598b5c39c873901d8c6ccef979342e8da0e613f))
...
* **lzip:** fix broken case patterns for long and short options ([9bdd734](https://github.com/scop/bash-completion/commit/9bdd734a86252c431105bd1cc93bcf64ce4d3f6f))
* **man,info:** fix for failglob ([46ed131](https://github.com/scop/bash-completion/commit/46ed13120649ef5f64f097b21244c7ee145123f6))
* **man,info:** suppress unexpected code execution ([07ea44b](https://github.com/scop/bash-completion/commit/07ea44b4d0ea1806496fe9ba25dd71203fedc15f))
...
* **minicom:** do not generate empty completions ([b7396b5](https://github.com/scop/bash-completion/commit/b7396b50bdc948a40f81940d4994b6de94e3f81b))
* **minicom:** fix broken double quotation ([22db6dc](https://github.com/scop/bash-completion/commit/22db6dc864b1ce7e90cfc508084c6f108184cf75))
* **mutt:** default mail dir assignment ([08206e7](https://github.com/scop/bash-completion/commit/08206e72cf3da9e71ff8aaf03dfb5a4a15538afd))
* **nox:** improve the PATH manipulation ([#920](https://github.com/scop/bash-completion/issues/920)) ([1d2aac1](https://github.com/scop/bash-completion/commit/1d2aac1221a39be866fff0544d0da757544e4d9e))
* **nox:** invoked sed as `command sed` ([5f92486](https://github.com/scop/bash-completion/commit/5f924867f7f5dad3ad2510c9d548a4301c825230))
...
* **postfix:** use param $2 of `_parse_help` ([c609196](https://github.com/scop/bash-completion/commit/c60919644cb43f6d36e46e3a52ec97dc40bba191))
* protect ${a[@]+"${a[@]}"} from IFS in Bash 5.2 ([9f60090](https://github.com/scop/bash-completion/commit/9f600901fedb3662ca4f7968826d7bde5a3e4860))
...
* **puppet,valgrind:** work around localvar_inherit ([59a3b49](https://github.com/scop/bash-completion/commit/59a3b495f2f20589b6a21282d36184865879251a))
* **pwdx:** fix use of _parse_help ([1623682](https://github.com/scop/bash-completion/commit/1623682e88b41e1dcd1195055460c05c910a9948))
...
* **qemu,rdesktop:** fix stray } in -W option arguments ([1e68c7a](https://github.com/scop/bash-completion/commit/1e68c7ac634ce9367a89c8eca73aad4631d38fcf))
* **reportbug,ypmatch:** quote arguments ([408bef0](https://github.com/scop/bash-completion/commit/408bef0c9f4c1a62eecc7d1e1c474eb47c32c19c))
...
* **ssh:** deprecated option PubkeyAcceptedKeyTypes ([7c0084e](https://github.com/scop/bash-completion/commit/7c0084e0f4d82a9b4d76f72e28b8afe773146de7))
* **ssh:** protect against localvar_inherit ([6e5cb3d](https://github.com/scop/bash-completion/commit/6e5cb3d6fbbf9cdc12adb74df14cd87a0a90ccea))
* **ssh:** protect against word splitting ([92f288d](https://github.com/scop/bash-completion/commit/92f288d7e2d3f7249fdd90e57e7fd46ac0274797))
...
* **strace:** fix the test for an associative array ([223aa08](https://github.com/scop/bash-completion/commit/223aa08665959fcecc4c0191f7a5bcc44d3cf05c))
* **sudo:** fix option names in the command-offset search ([1cf6fa6](https://github.com/scop/bash-completion/commit/1cf6fa6aadcd6162cdbe78e9462f611bfcd0fdb0))
* **svcadm:** fix for localvar_inherit ([b05d37a](https://github.com/scop/bash-completion/commit/b05d37aa330ed7ff7cb1dee2e3acdaabc992e2d5))
* switch from `if $var` to `if [[ $var ]]` for custom IFS ([78e4e4a](https://github.com/scop/bash-completion/commit/78e4e4acd32532292780b201a69c8099914c349f))
* **tar:** fix access of the global variable `basic_tar` ([128b975](https://github.com/scop/bash-completion/commit/128b97566d1908d8242e59b25fdf48c4f36211ab))
...
* use _comp_compgen for COMPREPLY+=($(compgen ... -- "...")) ([7f6ba5b](https://github.com/scop/bash-completion/commit/7f6ba5b26bb0a560bcb193b36e4751c573a9c592))
* use _comp_compgen for COMPREPLY+=($(compgen ... -- "$cur")) ([87509ba](https://github.com/scop/bash-completion/commit/87509ba8e767dc8affabc81efd119ff4a3d44d3e))
* use _comp_compgen for COMPREPLY+=($(compgen ...)) ([446b599](https://github.com/scop/bash-completion/commit/446b599464bce87090647edf50699735b3d0e701))
* use _comp_compgen for COMPREPLY=($(compgen ... -- "...")) ([2a1a9e1](https://github.com/scop/bash-completion/commit/2a1a9e1f0b7afa309a5d2dd2c8fb692d46695573))
* use _comp_compgen for COMPREPLY=($(compgen ... -- "...")) (v2) ([61e4b57](https://github.com/scop/bash-completion/commit/61e4b57fdc6b7c9fee98ba581ebaebef133879fd))
* use _comp_compgen for COMPREPLY=($(compgen ... -- "$cur")) ([5701a79](https://github.com/scop/bash-completion/commit/5701a795f99cee1a5669f217bcaae00548dc0d1a))
* use _comp_compgen for COMPREPLY=($(compgen ... -- "$cur")) (v2) ([18723c8](https://github.com/scop/bash-completion/commit/18723c81025106178ec15013fc5993c5a53cefd3))
* use _comp_compgen for COMPREPLY=($(compgen ... misc)) ([3c908c4](https://github.com/scop/bash-completion/commit/3c908c47c4d38743ba8bf4beaa44fcf666914b67))
* use _comp_compgen for COMPREPLY=($(compgen ...) $(comgpen ...)) ([db9a031](https://github.com/scop/bash-completion/commit/db9a0317888e1566fe6ad9c4cf58cea1d8d4e27e))
* use _comp_compgen for COMPREPLY=($(compgen ...)) ([e88fca5](https://github.com/scop/bash-completion/commit/e88fca55a57273dd94c95447d214e98cdc93ae71))
...
* work around localvar_inherit for [[ -v var ]] ([b27c380](https://github.com/scop/bash-completion/commit/b27c38037d4cdb64acd5c0a60bcfdd22c6125727))
* **wtf:** fix for missing optarg ([c889cf6](https://github.com/scop/bash-completion/commit/c889cf66f7b5932939a136e236adaa0b9794cd10))
...
* **xfunc ssh scp_local_files:** fix for failglob ([f391bbb](https://github.com/scop/bash-completion/commit/f391bbbb2a3ddb179594250afcf64fc7b26b7638))
* **xfunc ssh scp_remote_files:** protect against failglob ([4babb5a](https://github.com/scop/bash-completion/commit/4babb5a959ae22ceb92bb999079c384ce5260b32))
* **xgamma:** avoid unexpected expansion by -W ([acebdc0](https://github.com/scop/bash-completion/commit/acebdc0af5c46edc517e619e35a1db6f4439f8b4))


### Performance Improvements

* **__load_completion:** avoid a subshell on completion install check ([03bdac4](https://github.com/scop/bash-completion/commit/03bdac41019e432d48ab887a11b4b95c19a9455b))
* **__load_completion:** reduce number of `stat` calls ([42b2c02](https://github.com/scop/bash-completion/commit/42b2c0211cb18a98e7cd4727a5aa9a69e3fa1f31))
